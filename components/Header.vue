    ...
    <div class="max-w-6xl mx-auto p-4 sm:px-6 h-full">
        ...
        <article class="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            <div>
                ...
                <p class="text-lg text-gray-700 flex-grow">Seeing what doesn’t exist yet, that’s my strength. I work hard to make it happen - in technology, ideas, and in your business.</p>
            </div>
			<a class="relative block group" href="#0">
                <div class="absolute inset-0 bg-green-400 hidden md:block transform md:translate-y-2 md:translate-x-4 xl:translate-y-4 xl:translate-x-8 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-700 ease-out pointer-events-none" aria-hidden="true"></div>
