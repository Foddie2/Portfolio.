        ...
        <div class="space-y-4 py-10">
          <p class="flex items-center">
            <svg
              ...
              class="w-5 h-5 mr-2 sm:mr-6 text-base text-gray-700">
              <path
                fill-rule="evenodd"
                d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"
                clip-rule="evenodd"></path>
            </svg>
            <span class="text-gray-500">Nairobi</span>
          </p>
          <p class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
            ...
            <span class="text-gray-500">TechIT G2</span>
          </p>  
          <p class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
            ...
            <span class="text-gray-500"> 0711974716 </span>
          </p>
          ...
          <p class="flex items-center">
            ...
            <span class="text-gray-500">Bensonagala@live.com</span>
          </p>
        </div>
      </div>
